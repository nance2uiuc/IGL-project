...
public class SurfaceWordNew {
	...
	protected final Map<Integer, Character> toLetter= new HashMap<Integer, Character>();
	 ...
	 * @param sw
	 */
	public SurfaceWordNew(String sw){
		surfaceWord = sw;
	...
	/**
	 *Retrurs the length of the sruface word.
	 * @return
	 */
